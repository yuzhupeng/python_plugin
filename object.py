...
def get_apply_data(pageno, applyids, cookie, applyno, bwfstatus):
    ...
    try:
        ...
        AcutalUser = table2.xpath(
            "./tr[2]/td/table/tr/td[2]/span/input")[0].get(
                'value', default=None)  #实际使用者
        InSideLine = table2.xpath(
            "./tr[2]/td/table/tr/td[4]/span/input")[0].get('value',
                                                           default=None)  #内线
        ...
        PhonePassenger = table2.xpath(
            "./tr[8]/td/table/tr/td[2]/span/input")[0].get(
                'value', default=None)  #联系人手机
        ShareCore = table2.xpath(
            "./tr[8]/td/table/tr/td[6]/span/input")[0].get('value',
                                                           default=None)  #经费代码
        CostDepartment = table2.xpath(
            "./tr[8]/td/table/tr/td[4]/span/input")[0].get('value',
                                                           default=None)  #部门
        applyperson = table2.xpath(
            "./tr[15]/td/table/tr[5]/td[2]/span")[0].text  #申请人
        applydate = table2.xpath(
            "./tr[15]/td/table/tr[6]/td[2]/span")[0].text  #申请日期
        ...
        for item in trs:
            ...
            if len(tds) > 0:
                ...
                travel = tds[2].xpath("./span/input")[0].get('value',
                                                             default=None)  #行程
                OstartTime = tds[3].xpath("./span/input")[0].get(
                    'value', default=None)  #出发日期
                ReturnTime = tds[4].xpath("./span/input")[0].get(
                    'value', default=None)  #返回日期
                FlightNo = tds[5].xpath("./span/input")[0].get(
                    'value', default=None)  #航班号
                FlightTime = tds[6].xpath("./span/input")[0].get(
        ...
        applyform = {
            ...
            'reason': reason,
            'userason': usereason,
            'DetailedAddress': DetailedAddres,
