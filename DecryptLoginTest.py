...
parser.add_argument("--filepath", type=str, default="D:\\KPTG\\2021-09-01\\5934.JPG")
parser.add_argument("--regionfilepath", type=str, default="5_1.jpg")
args = parser.parse_args()

#id = args.filepath  # 不给也可以 默认01
#asd = args.regionfilepath  # 不给也可以 默认0
...
height = im.size[1]
rate = height / width
#layout_photo_5_1(resize_photo(cut_photo(im,1),1)).save(args.regionfilepath,dpi=(300.0, 300.0))
resize_photo(cut_photo(im,1),1).save(args.regionfilepath,dpi=(300.0, 300.0))
