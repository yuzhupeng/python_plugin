...
class Edit(Tab):
    def __init__(self, parent, **kwargs):
        ...
        self.record.grid(row=2, column=2, sticky=tk.NSEW, padx=5, pady=5)

        self.minimap = Minimap(self)
        self.minimap.grid(row=0, column=2, sticky=tk.NSEW, padx=5, pady=5)

        self.status = Status(self)
        self.status.grid(row=1, column=2, sticky=tk.NSEW, padx=5, pady=5)

        self.routine = Routine(self)
        self.routine.grid(row=0, column=0, rowspan=3, sticky=tk.NSEW, padx=5, pady=5)

        self.editor = Editor(self)
        self.editor.grid(row=0, column=1, rowspan=3, sticky=tk.NSEW, padx=5, pady=5)
