...
def start_autocubing():
    ...
    global stop_event
    global handles
    handles = windll.user32.FindWindowW(None, "MapleStory")
    ...
    stop_event.clear()
    autocubing_thread = threading.Thread(target=autocubing_main, args=(handles,selected_cube,selected_potential, input_lines, True3_box_select, Above160_box_select, stop_event))
